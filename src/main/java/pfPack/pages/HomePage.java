...
public class HomePage extends BasePage {
	...
	/*
	 * @FindBy(css="span[class^='zicon-apps-calendar']") public WebElement Calender;
	 * 
	 * @FindBy(css="span[class^='zicon-apps-chat']") public WebElement Cliq;
	 * 
	 * @FindBy(css="span[class^='zicon-apps-crm']") public WebElement CRM;
	 * 
	 * @FindBy(css="span[class^='zicon-apps-mail']") public WebElement Mail;
	 * 
	 * @FindBy(css="span[class^='zicon-apps-salesiq']") public WebElement SalesIQ;
	 */
