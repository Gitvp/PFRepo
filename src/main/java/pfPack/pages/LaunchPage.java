...
public class LaunchPage extends BasePage {
	...
	/*
	 * @FindBy(className="zh-customers") public WebElement Customers;
	 * 
	 * @FindBy(className="zh-support") public WebElement Support;
	 * 
	 * @FindBy(className="zh-login") public WebElement Login;
	 * 
	 * @FindBy(className="zh-signup") public WebElement SignUp;
	 */
